...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> ChangePassword(UserForPasswordDto userForPasswordDto, string newPassword)
        {
            ...
            if (!userForPasswordDto.NewPassword.Equals(userForPasswordDto.confirmNewPassword))
            {
                return new ErrorDataResult<User>("Password repeat incorrect");
            };
